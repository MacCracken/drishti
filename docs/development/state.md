...
## Gates (all green, 2026-07-18)

- `make build` — smoke exercises one real operation per family, exit 0
- `make test` — 38 suites / **28,890 assertions** (run `make test` for the current
...
>
> **Remaining to AV1 100%:** ~15–30 patches (inter ~1 — just scaled-ref MC · film grain 2–3 · the
...
**The AV1 inter layer — NEARLY COMPLETE** (only scaled-reference/BILINEAR MC remains; the
