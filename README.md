...
## Status — 0.7.51 (AV1 decode: raw bytes → pixels; 8/10/12-bit; multi-tile + multi-tile-group frames)

The bitstream/container/header layer of every family is built, spec-
derived, and adversarially tested (20,572 suite assertions + 1,140 fuzz
