...
## Status — 0.7.63 (AV1 decode: raw bytes → pixels; 8/10/12-bit; multi-tile; superres; inter: MC driver + DPB + MV-prediction + candidate stack)

The bitstream/container/header layer of every family is built, spec-
derived, and adversarially tested (21,332 suite assertions + 1,140 fuzz
