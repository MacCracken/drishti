...
## Status — 0.7.61 (AV1 decode: raw bytes → pixels; 8/10/12-bit; multi-tile; superres; inter: MC driver + DPB / ref-frame buffer)

The bitstream/container/header layer of every family is built, spec-
derived, and adversarially tested (21,199 suite assertions + 1,140 fuzz
