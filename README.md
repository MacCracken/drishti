...
## Status — 0.7.65 (AV1 decode: raw bytes → pixels; 8/10/12-bit; multi-tile; superres; inter: MC driver + DPB + find_mv_stack)

The bitstream/container/header layer of every family is built, spec-
derived, and adversarially tested (21,454 suite assertions + 1,140 fuzz
