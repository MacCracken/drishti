...
## Status — 0.7.64 (AV1 decode: raw bytes → pixels; 8/10/12-bit; multi-tile; superres; inter: MC driver + DPB + MV-prediction + candidate stack + spatial scans)

The bitstream/container/header layer of every family is built, spec-
derived, and adversarially tested (21,394 suite assertions + 1,140 fuzz
