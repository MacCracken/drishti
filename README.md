...
## Status — 0.7.36 (AV1 intra keyframe decode complete; in-loop filter layer in; loop-restoration bitstream substrate underway)

The bitstream/container/header layer of every family is built, spec-
derived, and adversarially tested (20,324 suite assertions + 1,140 fuzz
