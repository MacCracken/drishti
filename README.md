...
## Status — 0.7.62 (AV1 decode: raw bytes → pixels; 8/10/12-bit; multi-tile; superres; inter: MC driver + DPB + MV-prediction foundation)

The bitstream/container/header layer of every family is built, spec-
derived, and adversarially tested (21,253 suite assertions + 1,140 fuzz
