...
## Status — 0.7.67 (AV1 decode: raw bytes → pixels; 8/10/12-bit; multi-tile; superres; inter: MC driver + DPB + find_mv_stack + inter mode/MV reads)

The bitstream/container/header layer of every family is built, spec-
derived, and adversarially tested (21,720 suite assertions + 1,140 fuzz
